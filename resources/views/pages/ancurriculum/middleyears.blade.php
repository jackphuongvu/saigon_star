...
<div class="full left subpage_content pgacademic">
   ...
   `              </div>
			...
			<div class="cbi_scrollbar content_left">
				<h1>International Middle Year Curriculum</h1>
				<div class="clr"></div>
				...
				<p style="text-align: justify;">
					...
					<i>“The IMYC is more than just a set of subject activities. It is a transformative and broad curriculum; it builds a culture and community focused on inspiring and engaging students, and supporting their learning needs. Learning happens everywhere, in school, at home and even on vacation as students take responsibility for their own learning.”</i></p>
					...
					<figure style="text-align: center; font-size: 11px;">
						<img style="display: block; margin-left: auto; margin-right: auto;" src="{{asset('images/betraiA.jpg')}}" alt="Early Years at  HCMC" width="640" height="480">
						<figcaption>
							<em>Communication and play provide the foundation for children’s learning</em>
						</figcaption>
						<figcaption></figcaption>
					</figure>
					<figure style="text-align: center; font-size: 11px;">
						<img style="display: block; margin-left: auto; margin-right: auto;" src="{{asset('images/betraiA.jpg')}}" alt="Early Years at HCMC" width="640" height="auto">
						<figcaption><em>Play provides children with opportunities to explore, discover, create and experiment</em>
						</figcaption>
						<figcaption></figcaption>
					</figure>
					<p style="text-align: justify;">
						<span style="font-weight: 400;">
						<iframe src="//www.youtube.com/watch?v=F5USmxGn1pg" width="100%" height="300" allowfullscreen="allowfullscreen"></iframe>
						</span>
					</p>				
				</div>
			</div>
